<template>
    <el-row style="width: 1500px;background-color: rgb(255,255,255);border-radius: 2px;margin: 0 auto;">
        <el-col :span="16" style="padding: 10px 20px;border-right: 1px solid rgb(245,245,245);">
            <div style="position: sticky;top: 65px;z-index: 100;background-color: rgb(255,255,255);padding-block: 10px;">
        ...
        <el-col :span="8" style="padding: 10px 20px;position: sticky;top: 60px;">
            <!-- 内容推荐 -->
            <content-recommend 
                :gourmet-id="Number(gourmetId)"
                @recommend-click="readGourmet"
            />
...
import ContentRecommend from "@/components/recommend/ContentRecommend.vue"
